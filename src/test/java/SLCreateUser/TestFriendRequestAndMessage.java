...
public class TestFriendRequestAndMessage {
    ...
    public void LogInUser1() throws InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("/html/body/app-root/section/app-slp-platform/section/app-slp-my-stream/div/slp-stream-header/div/div[1]/p[2]")));
        driver.findElement(By.xpath("/html/body/app-root/section/app-slp-platform/section/app-slp-header/div/div[2]/button[1]/span/mat-icon[1]")).click(); //open Find Menu
        Thread.sleep(1000);
    ...
    public void LogInUser2() throws InterruptedException {
        ...
        Thread.sleep(1500);
        //wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/slp-send-message-dialog/slp-dialog-wrapper/div[3]/div/div/slp-select-file/input")));
        driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/mat-dialog-container/slp-send-message-dialog/slp-dialog-wrapper/div[2]/div/div[6]/div/textarea")).sendKeys("Test message"); //message
